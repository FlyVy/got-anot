...
import com.isp.gotanot.Class.Student;
import com.isp.gotanot.Class.User;
import com.isp.gotanot.ui.login.LoginInfo;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerviewItemAdapter.setOnItemClickListener(new ClickListener() {
            ...
            public void onClick(View view, Object data, int position) {
                Toast.makeText(getActivity(), position +"th event", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        evt_root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try {
                    ...
                    Toast.makeText(getActivity().getApplication(),user.getEventIDs().size() == 0?"No events to view!":"Events ready to view!", Toast.LENGTH_SHORT).show();
                    //recyclerviewItemAdapter.updateList(bookingEvents);
